...
data = [2224, 1961, 1931, 1480, 1440, 984, 838, 753, 745, 817, 692, 685, 788, 752, 703, 581, 577, 499, 482, 473, 510, 469, 472, 431, 416, 369]

# Save CSV
with open(r'C:\Users\gabriel.croquer\Desktop\agencia-sp-templates\INFOGRAFICOS\SSP_HOMICIDIOS_BIMESTRE\homicidios_bimestre.csv', 'w', newline='', encoding='utf-8') as f:
    w = csv.writer(f)
    w.writerow(['Ano', 'Homicidio_Doloso'])
...
<head>
  ...
  <title>Homicidios dolosos em SP - 1o bimestre 2026</title>
...
(function() {
  ...
  for (var t = 0; t <= nTicks; t++) {
    ...
    if (val >= 1000) {
      label.textContent = (val / 1000).toFixed(val % 1000 === 0 ? 0 : 1) + " mil";
    } else {
...
outpath = r'C:\Users\gabriel.croquer\Desktop\agencia-sp-templates\INFOGRAFICOS\SSP_HOMICIDIOS_BIMESTRE\homicidios_bimestre_2026.html'
